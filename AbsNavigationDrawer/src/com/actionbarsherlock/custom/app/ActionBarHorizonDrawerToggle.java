...
import com.actionbarsherlock.custom.widget.HorizonDrawerLayout;
 ...
 * {@link HorizonDrawerLayout} and the framework <code>ActionBar</code> to implement the recommended
 ...
 * {@link HorizonDrawerLayout.DrawerListener}, or if you are already providing your own listener,
 * call through to each of the listener methods from your own.</p>
 */
public class ActionBarHorizonDrawerToggle implements HorizonDrawerLayout.DrawerListener {
    ...
    private final HorizonDrawerLayout mDrawerLayout;
     ...
     *
     * <p>The given {@link Activity} will be linked to the specified {@link HorizonDrawerLayout}.
     ...
     *                                  for accessibility
     */
    public ActionBarHorizonDrawerToggle(Activity activity, ActionBar actionBar, HorizonDrawerLayout drawerLayout,
    ...
    public void syncState() {
        ...
        if (mDrawerIndicatorEnabled) {
        	...
        	mActionBar.setHomeActionContentDescription(mDrawerLayout.isDrawerOpen(mGravity) ?
    ...
    /**
     * {@link HorizonDrawerLayout.DrawerListener} callback method. If you do not use your
